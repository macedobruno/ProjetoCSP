 ...
 * 
 */
public class HorarioDiferenteConstraint<VAR extends Variable, VAL> implements Constraint<VAR, List<String>> {

	private VAR var1;
	private VAR var2;
	private List<VAR> scope;

	public HorarioDiferenteConstraint(VAR var1, VAR var2) {
		this.var1 = var1;
		this.var2 = var2;
