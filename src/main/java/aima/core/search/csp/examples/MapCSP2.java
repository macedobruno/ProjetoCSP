...
public class MapCSP2 extends CSP<Variable, String> {
...
//			
//			valores.add(Arrays.asList(aula, prof));
//		}
//	}
	...
	public MapCSP2() {
		...
		Domain<String> colors = new Domain<>(aulas);
		for (Variable var : getVariables())
			setDomain(var, colors);

		addAll(variaveis, 0);
		addConstraint(new AtribHorarioConstraint<>(ESII1, "QUI17"));
		addConstraint(new AtribHorarioConstraint<>(ESII2, "QUI19"));
	}
